...
# test network home var targets to talent-credentials-network folder
# the reason we use a var here is considering with org3 specific folder
# when invoking this for org3 as talent-credentials-network/scripts/org3-scripts
# the value is changed from default as $PWD (talent-credentials-network)
