      ...
      <div className="w-full overflow-x-auto">
        <table className="w-full table-auto bg-white shadow-md rounded">
          <thead className="bg-gray-200">
            <tr>
              <th className="w-32 p-2">ID</th>
              <th className="w-32">Name</th>
              <th className="w-24">Type</th>
              <th className="w-40">Institution</th>
              <th className="w-40">Education</th>
              <th className="w-40">Company</th>
              <th className="w-48">Work Exp.</th>
              <th className="w-40">Skills</th>
              <th className="w-28">Status</th>
              <th className="w-32">Verified By</th>
              <th className="w-28">Talent ID</th>
                  ...
                  <td className="p-2">
                    ...
                    <div>
                      <button
                        ...
                        className="w-full px-2 py-1 bg-gray-200 text-gray-700 rounded hover:bg-gray-300"
                      >
                        Delete
                      </button>
                    </div>
